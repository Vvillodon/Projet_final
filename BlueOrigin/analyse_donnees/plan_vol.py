...
class PlanVol():
    ...
    def calcul_valeurs_normees(self):
        ...
        altitude_normee = np.sqrt(self.x_cartesian**2+self.y_cartesian**2+self.z_cartesian**2)
        vitesse_normee = np.sqrt(self.vx_ecef**2+self.vy_ecef**2+self.vz_ecef**2)
    ...
    def creer_plan_vol(self):
        ...
        altitude_normee,vitesse_normee=calcul_valeurs_normees(self)
        ...
        while tp_liftoff==0 or tp_MECO==0 or tp_apogee==0 or tp_deploy_brakes==0 or tp_restart_ignition==0 or tp_touchdown==0:
            ...
            altitude_before=self.z_cartesian[i]
